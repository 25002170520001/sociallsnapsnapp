...
Get-ChildItem -Path $cwd -Recurse -File | Where-Object { $_.FullName -notmatch "\\\\.git\\\\" -and $_.FullName -notmatch "\\\\.vercel\\\\" -and $_.FullName -notmatch "\\\\node_modules\\\\" } | ForEach-Object {
  $relative = $_.FullName.Substring($cwd.Length).TrimStart('\', '/')
